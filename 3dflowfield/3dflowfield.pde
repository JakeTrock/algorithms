...
//HEY DMO, IF YOU DIDN'T REMEMBER FROM BEFORE, THIS PROGRAM IS REALLY HARD TO USE WITHOUT A MOUSE, I RECCOMEND YOU GRAB ONE BEFORE STARTING THE PROGRAM. I WILL NOW STOP YELLING.
...
int sx,sy,sz;
void setup() {
  sx=int(random(200,800));//create random playfield
  sy=int(random(200,800));
  sz=int(random(200,800));
  fullScreen(P3D);
  camera = new PeasyCam(this, 0, 0, 0, 2*sz);//initialize 3d canvas and camera
  ff = new FlowField(15);
